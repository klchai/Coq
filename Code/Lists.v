...
Fixpoint alternate (l1 l2 : natlist) : natlist :=
  match l1, l2 with
    | nil, l2 => l2
    | h :: hs, nil => h :: hs
    | h1 :: h1s, h2 :: h2s => h1 :: h2 :: alternate h1s h2s
  end.
...
Definition member (v:nat) (s:bag) : bool := negb (eqb O (count v s)).
...
Lemma beq_lemma : forall n, eqb n n = true.
Proof.
...
Proof.
  intros.
  destruct b as [| x xs].
  - simpl. rewrite -> beq_lemma. reflexivity.
  - simpl. rewrite -> beq_lemma. reflexivity. Qed.
...
Proof.
  ...
  - simpl. rewrite -> IHxs. rewrite -> app_assoc. reflexivity. Qed.
...
Proof.
  intros. induction l as [| x xs].
  - reflexivity.
  - simpl. rewrite <- cons_rev. rewrite -> IHxs. reflexivity. Qed.
...
Proof.
  intros. induction l.
  - reflexivity.
  - simpl. rewrite <- eqb_refl, IHl. reflexivity. Qed.
(** [] *)
...
Proof.
  intros. simpl. rewrite <- eqb_id_refl. reflexivity. Qed.
(** [] *)
