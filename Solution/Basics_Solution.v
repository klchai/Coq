...
(** The pattern [primary _] here is shorthand for "[primary] applied
    ...
    has the same effect as the dummy pattern variable [q] in the
...
(** Moreover, it will be useful later to know that [reflexivity]
    ...
    _context_ of current assumptions. Note that [n] is bound in the
    goal, and we could have used any other (fresh) identifer:
*)
...
Proof.
  intros f H b.
  rewrite H. rewrite H. destruct b eqn:E.
  - reflexivity.
  - reflexivity. Qed.
...
Proof.
  (* SOLUTION: *)
  intros b c. (* we only introduce b and c, but not yet H *)
  destruct b eqn:E.
...
(* SOLUTION: *) Proof. reflexivity.  Qed.
...
(* Wed 28 Aug 2019 06:48:47 PM CEST *)
